// Shared world-map geo helpers. Both the personal Map page and the Territory
// battle page render react-simple-maps from the same world-atlas TopoJSON, which
// keys countries by ISO 3166-1 *numeric* id — our DB uses alpha-2. Kept in one
// place so the lookup table can't drift between the two maps.

export const GEO_URL = 'https://cdn.jsdelivr.net/npm/world-atlas@2/countries-110m.json';

export const NUM_TO_ALPHA2 = {

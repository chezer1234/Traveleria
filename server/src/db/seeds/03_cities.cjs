...
const cities = [
  ...
  // ── Tier 0 Phase 3 (issue #46): remaining US states + China provinces ──────
  // Bringing every Tier 0 state/province to the 4-loggable-city minimum.
  // Populations are rounded, best-effort figures (2020-census-era for US;
  // most-recent-published prefecture/city figures for China) — not sourced
  // from a single dataset the way 01_countries.js is, so treat as
  // approximate pending a spot-check, per CLAUDE.md's data-quality note.

  // US states with existing majors — topping up to 4
  { country_code: 'US', name: 'Buffalo', population: 278349, province_code: 'US-NY', city_type: 'additional' },
  { country_code: 'US', name: 'Rochester', population: 211328, province_code: 'US-NY', city_type: 'additional' },
  { country_code: 'US', name: 'Yonkers', population: 211569, province_code: 'US-NY', city_type: 'additional' },
  { country_code: 'US', name: 'Aurora', population: 180542, province_code: 'US-IL', city_type: 'additional' },
  { country_code: 'US', name: 'Naperville', population: 148449, province_code: 'US-IL', city_type: 'additional' },
  { country_code: 'US', name: 'Joliet', population: 150362, province_code: 'US-IL', city_type: 'additional' },
  { country_code: 'US', name: 'Tucson', population: 545975, province_code: 'US-AZ', city_type: 'additional' },
  { country_code: 'US', name: 'Mesa', population: 504258, province_code: 'US-AZ', city_type: 'additional' },
  { country_code: 'US', name: 'Chandler', population: 275987, province_code: 'US-AZ', city_type: 'additional' },
  { country_code: 'US', name: 'Pittsburgh', population: 302971, province_code: 'US-PA', city_type: 'additional' },
  { country_code: 'US', name: 'Allentown', population: 125845, province_code: 'US-PA', city_type: 'additional' },
  { country_code: 'US', name: 'Erie', population: 94831, province_code: 'US-PA', city_type: 'additional' },
  { country_code: 'US', name: 'Tampa', population: 384959, province_code: 'US-FL', city_type: 'additional' },
  { country_code: 'US', name: 'Orlando', population: 307573, province_code: 'US-FL', city_type: 'additional' },
  { country_code: 'US', name: 'Spokane', population: 228989, province_code: 'US-WA', city_type: 'additional' },
  { country_code: 'US', name: 'Tacoma', population: 219346, province_code: 'US-WA', city_type: 'additional' },
  { country_code: 'US', name: 'Vancouver', population: 190915, province_code: 'US-WA', city_type: 'additional' },
  { country_code: 'US', name: 'Colorado Springs', population: 478961, province_code: 'US-CO', city_type: 'additional' },
  { country_code: 'US', name: 'Aurora', population: 386261, province_code: 'US-CO', city_type: 'additional' },
  { country_code: 'US', name: 'Fort Collins', population: 169810, province_code: 'US-CO', city_type: 'additional' },
  { country_code: 'US', name: 'Memphis', population: 633104, province_code: 'US-TN', city_type: 'additional' },
  { country_code: 'US', name: 'Knoxville', population: 190740, province_code: 'US-TN', city_type: 'additional' },
  { country_code: 'US', name: 'Chattanooga', population: 181099, province_code: 'US-TN', city_type: 'additional' },
  { country_code: 'US', name: 'Worcester', population: 206518, province_code: 'US-MA', city_type: 'additional' },
  { country_code: 'US', name: 'Springfield', population: 155929, province_code: 'US-MA', city_type: 'additional' },
  { country_code: 'US', name: 'Cambridge', population: 118403, province_code: 'US-MA', city_type: 'additional' },
  { country_code: 'US', name: 'Henderson', population: 320189, province_code: 'US-NV', city_type: 'additional' },
  { country_code: 'US', name: 'Reno', population: 264165, province_code: 'US-NV', city_type: 'additional' },
  { country_code: 'US', name: 'North Las Vegas', population: 262527, province_code: 'US-NV', city_type: 'additional' },
  // DC is a single city-state, like Beijing — "additional" entries are real
  // neighbourhoods/wards rather than distinct municipalities.
  { country_code: 'US', name: 'Georgetown', population: 14000, province_code: 'US-DC', city_type: 'additional' },
  { country_code: 'US', name: 'Capitol Hill', population: 35000, province_code: 'US-DC', city_type: 'additional' },
  { country_code: 'US', name: 'Anacostia', population: 40000, province_code: 'US-DC', city_type: 'additional' },

  // US states with zero pre-existing cities — all 4 new
  { country_code: 'US', name: 'Birmingham', population: 200733, province_code: 'US-AL', city_type: 'additional' },
  { country_code: 'US', name: 'Montgomery', population: 200603, province_code: 'US-AL', city_type: 'additional' },
  { country_code: 'US', name: 'Huntsville', population: 215006, province_code: 'US-AL', city_type: 'additional' },
  { country_code: 'US', name: 'Mobile', population: 187041, province_code: 'US-AL', city_type: 'additional' },
  { country_code: 'US', name: 'Anchorage', population: 291247, province_code: 'US-AK', city_type: 'additional' },
  { country_code: 'US', name: 'Fairbanks', population: 32515, province_code: 'US-AK', city_type: 'additional' },
  { country_code: 'US', name: 'Juneau', population: 32255, province_code: 'US-AK', city_type: 'additional' },
  { country_code: 'US', name: 'Sitka', population: 8458, province_code: 'US-AK', city_type: 'additional' },
  { country_code: 'US', name: 'Little Rock', population: 198042, province_code: 'US-AR', city_type: 'additional' },
  { country_code: 'US', name: 'Fort Smith', population: 89142, province_code: 'US-AR', city_type: 'additional' },
  { country_code: 'US', name: 'Fayetteville', population: 93949, province_code: 'US-AR', city_type: 'additional' },
  { country_code: 'US', name: 'Springdale', population: 84161, province_code: 'US-AR', city_type: 'additional' },
  { country_code: 'US', name: 'Bridgeport', population: 148654, province_code: 'US-CT', city_type: 'additional' },
  { country_code: 'US', name: 'New Haven', population: 134023, province_code: 'US-CT', city_type: 'additional' },
  { country_code: 'US', name: 'Hartford', population: 121054, province_code: 'US-CT', city_type: 'additional' },
  { country_code: 'US', name: 'Stamford', population: 135470, province_code: 'US-CT', city_type: 'additional' },
  { country_code: 'US', name: 'Wilmington', population: 70898, province_code: 'US-DE', city_type: 'additional' },
  { country_code: 'US', name: 'Dover', population: 38079, province_code: 'US-DE', city_type: 'additional' },
  { country_code: 'US', name: 'Newark', population: 33323, province_code: 'US-DE', city_type: 'additional' },
  { country_code: 'US', name: 'Middletown', population: 24118, province_code: 'US-DE', city_type: 'additional' },
  { country_code: 'US', name: 'Atlanta', population: 498715, province_code: 'US-GA', city_type: 'additional' },
  { country_code: 'US', name: 'Augusta', population: 202081, province_code: 'US-GA', city_type: 'additional' },
  { country_code: 'US', name: 'Columbus', population: 206922, province_code: 'US-GA', city_type: 'additional' },
  { country_code: 'US', name: 'Savannah', population: 147780, province_code: 'US-GA', city_type: 'additional' },
  { country_code: 'US', name: 'Honolulu', population: 350964, province_code: 'US-HI', city_type: 'additional' },
  { country_code: 'US', name: 'Hilo', population: 45248, province_code: 'US-HI', city_type: 'additional' },
  { country_code: 'US', name: 'Kailua', population: 38635, province_code: 'US-HI', city_type: 'additional' },
  { country_code: 'US', name: 'Kaneohe', population: 34597, province_code: 'US-HI', city_type: 'additional' },
  { country_code: 'US', name: 'Boise', population: 235684, province_code: 'US-ID', city_type: 'additional' },
  { country_code: 'US', name: 'Meridian', population: 117635, province_code: 'US-ID', city_type: 'additional' },
  { country_code: 'US', name: 'Nampa', population: 100200, province_code: 'US-ID', city_type: 'additional' },
  { country_code: 'US', name: 'Idaho Falls', population: 64818, province_code: 'US-ID', city_type: 'additional' },
  { country_code: 'US', name: 'Indianapolis', population: 887642, province_code: 'US-IN', city_type: 'additional' },
  { country_code: 'US', name: 'Fort Wayne', population: 270402, province_code: 'US-IN', city_type: 'additional' },
  { country_code: 'US', name: 'Evansville', population: 118414, province_code: 'US-IN', city_type: 'additional' },
  { country_code: 'US', name: 'South Bend', population: 103453, province_code: 'US-IN', city_type: 'additional' },
  { country_code: 'US', name: 'Des Moines', population: 214237, province_code: 'US-IA', city_type: 'additional' },
  { country_code: 'US', name: 'Cedar Rapids', population: 137710, province_code: 'US-IA', city_type: 'additional' },
  { country_code: 'US', name: 'Davenport', population: 101724, province_code: 'US-IA', city_type: 'additional' },
  { country_code: 'US', name: 'Sioux City', population: 82459, province_code: 'US-IA', city_type: 'additional' },
  { country_code: 'US', name: 'Wichita', population: 397532, province_code: 'US-KS', city_type: 'additional' },
  { country_code: 'US', name: 'Overland Park', population: 197238, province_code: 'US-KS', city_type: 'additional' },
  { country_code: 'US', name: 'Kansas City', population: 156607, province_code: 'US-KS', city_type: 'additional' },
  { country_code: 'US', name: 'Topeka', population: 126587, province_code: 'US-KS', city_type: 'additional' },
  { country_code: 'US', name: 'Louisville', population: 633045, province_code: 'US-KY', city_type: 'additional' },
  { country_code: 'US', name: 'Lexington', population: 322570, province_code: 'US-KY', city_type: 'additional' },
  { country_code: 'US', name: 'Bowling Green', population: 72294, province_code: 'US-KY', city_type: 'additional' },
  { country_code: 'US', name: 'Owensboro', population: 60183, province_code: 'US-KY', city_type: 'additional' },
  { country_code: 'US', name: 'New Orleans', population: 383997, province_code: 'US-LA', city_type: 'additional' },
  { country_code: 'US', name: 'Baton Rouge', population: 227470, province_code: 'US-LA', city_type: 'additional' },
  { country_code: 'US', name: 'Shreveport', population: 187593, province_code: 'US-LA', city_type: 'additional' },
  { country_code: 'US', name: 'Lafayette', population: 121374, province_code: 'US-LA', city_type: 'additional' },
  { country_code: 'US', name: 'Portland', population: 68408, province_code: 'US-ME', city_type: 'additional' },
  { country_code: 'US', name: 'Lewiston', population: 37121, province_code: 'US-ME', city_type: 'additional' },
  { country_code: 'US', name: 'Bangor', population: 31753, province_code: 'US-ME', city_type: 'additional' },
  { country_code: 'US', name: 'Auburn', population: 24061, province_code: 'US-ME', city_type: 'additional' },
  { country_code: 'US', name: 'Baltimore', population: 585708, province_code: 'US-MD', city_type: 'additional' },
  { country_code: 'US', name: 'Columbia', population: 104681, province_code: 'US-MD', city_type: 'additional' },
  { country_code: 'US', name: 'Germantown', population: 91249, province_code: 'US-MD', city_type: 'additional' },
  { country_code: 'US', name: 'Silver Spring', population: 81015, province_code: 'US-MD', city_type: 'additional' },
  { country_code: 'US', name: 'Detroit', population: 639111, province_code: 'US-MI', city_type: 'additional' },
  { country_code: 'US', name: 'Grand Rapids', population: 198917, province_code: 'US-MI', city_type: 'additional' },
  { country_code: 'US', name: 'Warren', population: 139387, province_code: 'US-MI', city_type: 'additional' },
  { country_code: 'US', name: 'Ann Arbor', population: 123851, province_code: 'US-MI', city_type: 'additional' },
  { country_code: 'US', name: 'Minneapolis', population: 429954, province_code: 'US-MN', city_type: 'additional' },
  { country_code: 'US', name: 'Saint Paul', population: 311527, province_code: 'US-MN', city_type: 'additional' },
  { country_code: 'US', name: 'Rochester', population: 121395, province_code: 'US-MN', city_type: 'additional' },
  { country_code: 'US', name: 'Duluth', population: 86697, province_code: 'US-MN', city_type: 'additional' },
  { country_code: 'US', name: 'Jackson', population: 153701, province_code: 'US-MS', city_type: 'additional' },
  { country_code: 'US', name: 'Gulfport', population: 72076, province_code: 'US-MS', city_type: 'additional' },
  { country_code: 'US', name: 'Southaven', population: 55641, province_code: 'US-MS', city_type: 'additional' },
  { country_code: 'US', name: 'Hattiesburg', population: 48730, province_code: 'US-MS', city_type: 'additional' },
  { country_code: 'US', name: 'Kansas City', population: 508090, province_code: 'US-MO', city_type: 'additional' },
  { country_code: 'US', name: 'St. Louis', population: 301578, province_code: 'US-MO', city_type: 'additional' },
  { country_code: 'US', name: 'Springfield', population: 169176, province_code: 'US-MO', city_type: 'additional' },
  { country_code: 'US', name: 'Columbia', population: 126254, province_code: 'US-MO', city_type: 'additional' },
  { country_code: 'US', name: 'Billings', population: 117116, province_code: 'US-MT', city_type: 'additional' },
  { country_code: 'US', name: 'Missoula', population: 75516, province_code: 'US-MT', city_type: 'additional' },
  { country_code: 'US', name: 'Great Falls', population: 60442, province_code: 'US-MT', city_type: 'additional' },
  { country_code: 'US', name: 'Bozeman', population: 53293, province_code: 'US-MT', city_type: 'additional' },
  { country_code: 'US', name: 'Omaha', population: 486051, province_code: 'US-NE', city_type: 'additional' },
  { country_code: 'US', name: 'Lincoln', population: 291082, province_code: 'US-NE', city_type: 'additional' },
  { country_code: 'US', name: 'Bellevue', population: 53663, province_code: 'US-NE', city_type: 'additional' },
  { country_code: 'US', name: 'Grand Island', population: 53131, province_code: 'US-NE', city_type: 'additional' },
  { country_code: 'US', name: 'Manchester', population: 115644, province_code: 'US-NH', city_type: 'additional' },
  { country_code: 'US', name: 'Nashua', population: 91322, province_code: 'US-NH', city_type: 'additional' },
  { country_code: 'US', name: 'Concord', population: 43976, province_code: 'US-NH', city_type: 'additional' },
  { country_code: 'US', name: 'Derry', population: 34317, province_code: 'US-NH', city_type: 'additional' },
  { country_code: 'US', name: 'Newark', population: 311549, province_code: 'US-NJ', city_type: 'additional' },
  { country_code: 'US', name: 'Jersey City', population: 292449, province_code: 'US-NJ', city_type: 'additional' },
  { country_code: 'US', name: 'Paterson', population: 159732, province_code: 'US-NJ', city_type: 'additional' },
  { country_code: 'US', name: 'Elizabeth', population: 137298, province_code: 'US-NJ', city_type: 'additional' },
  { country_code: 'US', name: 'Albuquerque', population: 564559, province_code: 'US-NM', city_type: 'additional' },
  { country_code: 'US', name: 'Las Cruces', population: 111385, province_code: 'US-NM', city_type: 'additional' },
  { country_code: 'US', name: 'Rio Rancho', population: 104046, province_code: 'US-NM', city_type: 'additional' },
  { country_code: 'US', name: 'Santa Fe', population: 87505, province_code: 'US-NM', city_type: 'additional' },
  { country_code: 'US', name: 'Charlotte', population: 874579, province_code: 'US-NC', city_type: 'additional' },
  { country_code: 'US', name: 'Raleigh', population: 467665, province_code: 'US-NC', city_type: 'additional' },
  { country_code: 'US', name: 'Greensboro', population: 296710, province_code: 'US-NC', city_type: 'additional' },
  { country_code: 'US', name: 'Durham', population: 283506, province_code: 'US-NC', city_type: 'additional' },
  { country_code: 'US', name: 'Fargo', population: 125990, province_code: 'US-ND', city_type: 'additional' },
  { country_code: 'US', name: 'Bismarck', population: 73622, province_code: 'US-ND', city_type: 'additional' },
  { country_code: 'US', name: 'Grand Forks', population: 59166, province_code: 'US-ND', city_type: 'additional' },
  { country_code: 'US', name: 'Minot', population: 48377, province_code: 'US-ND', city_type: 'additional' },
  { country_code: 'US', name: 'Columbus', population: 898553, province_code: 'US-OH', city_type: 'additional' },
  { country_code: 'US', name: 'Cleveland', population: 372624, province_code: 'US-OH', city_type: 'additional' },
  { country_code: 'US', name: 'Cincinnati', population: 309317, province_code: 'US-OH', city_type: 'additional' },
  { country_code: 'US', name: 'Toledo', population: 270871, province_code: 'US-OH', city_type: 'additional' },
  { country_code: 'US', name: 'Oklahoma City', population: 681054, province_code: 'US-OK', city_type: 'additional' },
  { country_code: 'US', name: 'Tulsa', population: 413066, province_code: 'US-OK', city_type: 'additional' },
  { country_code: 'US', name: 'Norman', population: 128026, province_code: 'US-OK', city_type: 'additional' },
  { country_code: 'US', name: 'Broken Arrow', population: 113540, province_code: 'US-OK', city_type: 'additional' },
  { country_code: 'US', name: 'Portland', population: 652503, province_code: 'US-OR', city_type: 'additional' },
  { country_code: 'US', name: 'Eugene', population: 176654, province_code: 'US-OR', city_type: 'additional' },
  { country_code: 'US', name: 'Salem', population: 175535, province_code: 'US-OR', city_type: 'additional' },
  { country_code: 'US', name: 'Gresham', population: 114247, province_code: 'US-OR', city_type: 'additional' },
  { country_code: 'US', name: 'Columbia', population: 137300, province_code: 'US-SC', city_type: 'additional' },
  { country_code: 'US', name: 'Charleston', population: 150227, province_code: 'US-SC', city_type: 'additional' },
  { country_code: 'US', name: 'North Charleston', population: 114852, province_code: 'US-SC', city_type: 'additional' },
  { country_code: 'US', name: 'Greenville', population: 70720, province_code: 'US-SC', city_type: 'additional' },
  { country_code: 'US', name: 'Sioux Falls', population: 192517, province_code: 'US-SD', city_type: 'additional' },
  { country_code: 'US', name: 'Rapid City', population: 74703, province_code: 'US-SD', city_type: 'additional' },
  { country_code: 'US', name: 'Aberdeen', population: 28495, province_code: 'US-SD', city_type: 'additional' },
  { country_code: 'US', name: 'Brookings', population: 24377, province_code: 'US-SD', city_type: 'additional' },
  { country_code: 'US', name: 'Salt Lake City', population: 200567, province_code: 'US-UT', city_type: 'additional' },
  { country_code: 'US', name: 'West Valley City', population: 140230, province_code: 'US-UT', city_type: 'additional' },
  { country_code: 'US', name: 'Provo', population: 115162, province_code: 'US-UT', city_type: 'additional' },
  { country_code: 'US', name: 'West Jordan', population: 116961, province_code: 'US-UT', city_type: 'additional' },
  { country_code: 'US', name: 'Burlington', population: 44743, province_code: 'US-VT', city_type: 'additional' },
  { country_code: 'US', name: 'South Burlington', population: 20292, province_code: 'US-VT', city_type: 'additional' },
  { country_code: 'US', name: 'Rutland', population: 15807, province_code: 'US-VT', city_type: 'additional' },
  { country_code: 'US', name: 'Barre', population: 8491, province_code: 'US-VT', city_type: 'additional' },
  { country_code: 'US', name: 'Virginia Beach', population: 459470, province_code: 'US-VA', city_type: 'additional' },
  { country_code: 'US', name: 'Norfolk', population: 238005, province_code: 'US-VA', city_type: 'additional' },
  { country_code: 'US', name: 'Chesapeake', population: 249422, province_code: 'US-VA', city_type: 'additional' },
  { country_code: 'US', name: 'Richmond', population: 226610, province_code: 'US-VA', city_type: 'additional' },
  { country_code: 'US', name: 'Charleston', population: 46536, province_code: 'US-WV', city_type: 'additional' },
  { country_code: 'US', name: 'Huntington', population: 45208, province_code: 'US-WV', city_type: 'additional' },
  { country_code: 'US', name: 'Morgantown', population: 30347, province_code: 'US-WV', city_type: 'additional' },
  { country_code: 'US', name: 'Parkersburg', population: 28601, province_code: 'US-WV', city_type: 'additional' },
  { country_code: 'US', name: 'Milwaukee', population: 577222, province_code: 'US-WI', city_type: 'additional' },
  { country_code: 'US', name: 'Madison', population: 269840, province_code: 'US-WI', city_type: 'additional' },
  { country_code: 'US', name: 'Green Bay', population: 107395, province_code: 'US-WI', city_type: 'additional' },
  { country_code: 'US', name: 'Kenosha', population: 99986, province_code: 'US-WI', city_type: 'additional' },

  // China — provinces with existing majors, topping up to 4.
  // Shanghai/Chongqing/Tianjin are direct-administered municipalities (like
  // Beijing) — "additional" entries there are real districts, not separate
  // municipalities. Populations for China are approximate prefecture-level
  // figures pending a proper spot-check.
  { country_code: 'CN', name: 'Pudong', population: 5681000, province_code: 'CN-SH', city_type: 'additional' },
  { country_code: 'CN', name: 'Huangpu', population: 651000, province_code: 'CN-SH', city_type: 'additional' },
  { country_code: 'CN', name: 'Xuhui', population: 1093000, province_code: 'CN-SH', city_type: 'additional' },
  { country_code: 'CN', name: 'Yuzhong', population: 645000, province_code: 'CN-CQ', city_type: 'additional' },
  { country_code: 'CN', name: 'Jiangbei', population: 850000, province_code: 'CN-CQ', city_type: 'additional' },
  { country_code: 'CN', name: 'Shapingba', population: 1130000, province_code: 'CN-CQ', city_type: 'additional' },
  { country_code: 'CN', name: 'Heping', population: 480000, province_code: 'CN-TJ', city_type: 'additional' },
  { country_code: 'CN', name: 'Nankai', population: 800000, province_code: 'CN-TJ', city_type: 'additional' },
  { country_code: 'CN', name: 'Hedong', population: 750000, province_code: 'CN-TJ', city_type: 'additional' },
  { country_code: 'CN', name: 'Dongguan', population: 10466000, province_code: 'CN-GD', city_type: 'additional' },
  { country_code: 'CN', name: 'Foshan', population: 9498000, province_code: 'CN-GD', city_type: 'additional' },
  { country_code: 'CN', name: 'Mianyang', population: 4869000, province_code: 'CN-SC', city_type: 'additional' },
  { country_code: 'CN', name: 'Deyang', population: 3617000, province_code: 'CN-SC', city_type: 'additional' },
  { country_code: 'CN', name: 'Leshan', population: 3235000, province_code: 'CN-SC', city_type: 'additional' },
  { country_code: 'CN', name: 'Yichang', population: 4082000, province_code: 'CN-HB', city_type: 'additional' },
  { country_code: 'CN', name: 'Xiangyang', population: 5675000, province_code: 'CN-HB', city_type: 'additional' },
  { country_code: 'CN', name: 'Jingzhou', population: 5691000, province_code: 'CN-HB', city_type: 'additional' },
  { country_code: 'CN', name: 'Ningbo', population: 9404000, province_code: 'CN-ZJ', city_type: 'additional' },
  { country_code: 'CN', name: 'Wenzhou', population: 9572000, province_code: 'CN-ZJ', city_type: 'additional' },
  { country_code: 'CN', name: 'Shaoxing', population: 5252000, province_code: 'CN-ZJ', city_type: 'additional' },
  { country_code: 'CN', name: 'Wuxi', population: 7466000, province_code: 'CN-JS', city_type: 'additional' },
  { country_code: 'CN', name: 'Xuzhou', population: 9083000, province_code: 'CN-JS', city_type: 'additional' },
  { country_code: 'CN', name: 'Baoji', population: 3230000, province_code: 'CN-SN', city_type: 'additional' },
  { country_code: 'CN', name: 'Xianyang', population: 4058000, province_code: 'CN-SN', city_type: 'additional' },
  { country_code: 'CN', name: 'Yulin', population: 3350000, province_code: 'CN-SN', city_type: 'additional' },
  { country_code: 'CN', name: 'Qiqihar', population: 4067000, province_code: 'CN-HL', city_type: 'additional' },
  { country_code: 'CN', name: 'Daqing', population: 2904000, province_code: 'CN-HL', city_type: 'additional' },
  { country_code: 'CN', name: 'Mudanjiang', population: 2260000, province_code: 'CN-HL', city_type: 'additional' },
  { country_code: 'CN', name: 'Shenyang', population: 9075000, province_code: 'CN-LN', city_type: 'additional' },
  { country_code: 'CN', name: 'Anshan', population: 3389000, province_code: 'CN-LN', city_type: 'additional' },
  { country_code: 'CN', name: 'Fushun', population: 2064000, province_code: 'CN-LN', city_type: 'additional' },
  { country_code: 'CN', name: 'Jinan', population: 9202000, province_code: 'CN-SD', city_type: 'additional' },
  { country_code: 'CN', name: 'Yantai', population: 7102000, province_code: 'CN-SD', city_type: 'additional' },
  { country_code: 'CN', name: 'Weifang', population: 9386000, province_code: 'CN-SD', city_type: 'additional' },

  // China — provinces with zero pre-existing cities, all 4 new.
  { country_code: 'CN', name: 'Hefei', population: 9369000, province_code: 'CN-AH', city_type: 'additional' },
  { country_code: 'CN', name: 'Wuhu', population: 3766000, province_code: 'CN-AH', city_type: 'additional' },
  { country_code: 'CN', name: 'Bengbu', population: 3296000, province_code: 'CN-AH', city_type: 'additional' },
  { country_code: 'CN', name: 'Huangshan', population: 1381000, province_code: 'CN-AH', city_type: 'additional' },
  { country_code: 'CN', name: 'Fuzhou', population: 8290000, province_code: 'CN-FJ', city_type: 'additional' },
  { country_code: 'CN', name: 'Xiamen', population: 5163000, province_code: 'CN-FJ', city_type: 'additional' },
  { country_code: 'CN', name: 'Quanzhou', population: 8783000, province_code: 'CN-FJ', city_type: 'additional' },
  { country_code: 'CN', name: 'Zhangzhou', population: 5152000, province_code: 'CN-FJ', city_type: 'additional' },
  { country_code: 'CN', name: 'Lanzhou', population: 4359000, province_code: 'CN-GS', city_type: 'additional' },
  { country_code: 'CN', name: 'Tianshui', population: 3005000, province_code: 'CN-GS', city_type: 'additional' },
  { country_code: 'CN', name: 'Baiyin', population: 1432000, province_code: 'CN-GS', city_type: 'additional' },
  { country_code: 'CN', name: 'Jiayuguan', population: 322000, province_code: 'CN-GS', city_type: 'additional' },
  { country_code: 'CN', name: 'Nanning', population: 8788000, province_code: 'CN-GX', city_type: 'additional' },
  { country_code: 'CN', name: 'Guilin', population: 4930000, province_code: 'CN-GX', city_type: 'additional' },
  { country_code: 'CN', name: 'Liuzhou', population: 4172000, province_code: 'CN-GX', city_type: 'additional' },
  { country_code: 'CN', name: 'Beihai', population: 1868000, province_code: 'CN-GX', city_type: 'additional' },
  { country_code: 'CN', name: 'Guiyang', population: 6006000, province_code: 'CN-GZ', city_type: 'additional' },
  { country_code: 'CN', name: 'Zunyi', population: 6127000, province_code: 'CN-GZ', city_type: 'additional' },
  { country_code: 'CN', name: 'Liupanshui', population: 2851000, province_code: 'CN-GZ', city_type: 'additional' },
  { country_code: 'CN', name: 'Kaili', population: 460000, province_code: 'CN-GZ', city_type: 'additional' },
  { country_code: 'CN', name: 'Haikou', population: 2873000, province_code: 'CN-HI', city_type: 'additional' },
  { country_code: 'CN', name: 'Sanya', population: 1039000, province_code: 'CN-HI', city_type: 'additional' },
  { country_code: 'CN', name: 'Wenchang', population: 545000, province_code: 'CN-HI', city_type: 'additional' },
  { country_code: 'CN', name: 'Qionghai', population: 500000, province_code: 'CN-HI', city_type: 'additional' },
  { country_code: 'CN', name: 'Shijiazhuang', population: 11235000, province_code: 'CN-HE', city_type: 'additional' },
  { country_code: 'CN', name: 'Tangshan', population: 7726000, province_code: 'CN-HE', city_type: 'additional' },
  { country_code: 'CN', name: 'Baoding', population: 9305000, province_code: 'CN-HE', city_type: 'additional' },
  { country_code: 'CN', name: 'Handan', population: 9174000, province_code: 'CN-HE', city_type: 'additional' },
  { country_code: 'CN', name: 'Zhengzhou', population: 12600000, province_code: 'CN-HA', city_type: 'additional' },
  { country_code: 'CN', name: 'Luoyang', population: 7057000, province_code: 'CN-HA', city_type: 'additional' },
  { country_code: 'CN', name: 'Kaifeng', population: 4823000, province_code: 'CN-HA', city_type: 'additional' },
  { country_code: 'CN', name: 'Nanyang', population: 9700000, province_code: 'CN-HA', city_type: 'additional' },
  { country_code: 'CN', name: 'Changsha', population: 8382000, province_code: 'CN-HN', city_type: 'additional' },
  { country_code: 'CN', name: 'Zhuzhou', population: 3902000, province_code: 'CN-HN', city_type: 'additional' },
  { country_code: 'CN', name: 'Xiangtan', population: 2768000, province_code: 'CN-HN', city_type: 'additional' },
  { country_code: 'CN', name: 'Yueyang', population: 5049000, province_code: 'CN-HN', city_type: 'additional' },
  { country_code: 'CN', name: 'Nanchang', population: 6255000, province_code: 'CN-JX', city_type: 'additional' },
  { country_code: 'CN', name: 'Jiujiang', population: 4726000, province_code: 'CN-JX', city_type: 'additional' },
  { country_code: 'CN', name: 'Ganzhou', population: 8970000, province_code: 'CN-JX', city_type: 'additional' },
  { country_code: 'CN', name: 'Jingdezhen', population: 1601000, province_code: 'CN-JX', city_type: 'additional' },
  { country_code: 'CN', name: 'Changchun', population: 9070000, province_code: 'CN-JL', city_type: 'additional' },
  { country_code: 'CN', name: 'Jilin', population: 3628000, province_code: 'CN-JL', city_type: 'additional' },
  { country_code: 'CN', name: 'Siping', population: 2986000, province_code: 'CN-JL', city_type: 'additional' },
  { country_code: 'CN', name: 'Tonghua', population: 2172000, province_code: 'CN-JL', city_type: 'additional' },
  { country_code: 'CN', name: 'Hohhot', population: 3446000, province_code: 'CN-NM', city_type: 'additional' },
  { country_code: 'CN', name: 'Baotou', population: 2711000, province_code: 'CN-NM', city_type: 'additional' },
  { country_code: 'CN', name: 'Ordos', population: 2153000, province_code: 'CN-NM', city_type: 'additional' },
  { country_code: 'CN', name: 'Chifeng', population: 4341000, province_code: 'CN-NM', city_type: 'additional' },
  { country_code: 'CN', name: 'Yinchuan', population: 2859000, province_code: 'CN-NX', city_type: 'additional' },
  { country_code: 'CN', name: 'Shizuishan', population: 725000, province_code: 'CN-NX', city_type: 'additional' },
  { country_code: 'CN', name: 'Wuzhong', population: 1443000, province_code: 'CN-NX', city_type: 'additional' },
  { country_code: 'CN', name: 'Guyuan', population: 1289000, province_code: 'CN-NX', city_type: 'additional' },
  { country_code: 'CN', name: 'Xining', population: 2465000, province_code: 'CN-QH', city_type: 'additional' },
  { country_code: 'CN', name: 'Golmud', population: 200000, province_code: 'CN-QH', city_type: 'additional' },
  { country_code: 'CN', name: 'Delingha', population: 90000, province_code: 'CN-QH', city_type: 'additional' },
  { country_code: 'CN', name: 'Haidong', population: 1396000, province_code: 'CN-QH', city_type: 'additional' },
  { country_code: 'CN', name: 'Urumqi', population: 4054000, province_code: 'CN-XJ', city_type: 'additional' },
  { country_code: 'CN', name: 'Kashgar', population: 733000, province_code: 'CN-XJ', city_type: 'additional' },
  { country_code: 'CN', name: 'Korla', population: 550000, province_code: 'CN-XJ', city_type: 'additional' },
  { country_code: 'CN', name: 'Turpan', population: 694000, province_code: 'CN-XJ', city_type: 'additional' },
  { country_code: 'CN', name: 'Lhasa', population: 867000, province_code: 'CN-XZ', city_type: 'additional' },
  { country_code: 'CN', name: 'Shigatse', population: 703000, province_code: 'CN-XZ', city_type: 'additional' },
  { country_code: 'CN', name: 'Nyingchi', population: 240000, province_code: 'CN-XZ', city_type: 'additional' },
  { country_code: 'CN', name: 'Chamdo', population: 700000, province_code: 'CN-XZ', city_type: 'additional' },
  { country_code: 'CN', name: 'Kunming', population: 8460000, province_code: 'CN-YN', city_type: 'additional' },
  { country_code: 'CN', name: 'Dali', population: 3456000, province_code: 'CN-YN', city_type: 'additional' },
  { country_code: 'CN', name: 'Lijiang', population: 1245000, province_code: 'CN-YN', city_type: 'additional' },
  { country_code: 'CN', name: 'Jinghong', population: 1220000, province_code: 'CN-YN', city_type: 'additional' },
  { country_code: 'CN', name: 'Taiyuan', population: 5304000, province_code: 'CN-SX', city_type: 'additional' },
  { country_code: 'CN', name: 'Datong', population: 3105000, province_code: 'CN-SX', city_type: 'additional' },
  { country_code: 'CN', name: 'Changzhi', population: 3143000, province_code: 'CN-SX', city_type: 'additional' },
  { country_code: 'CN', name: 'Jincheng', population: 2168000, province_code: 'CN-SX', city_type: 'additional' },
];
